...
4. **If any step fails or the numbers look wrong,** please file an issue:
   https://github.com/yongchand/gbrain-company/issues with:
...
2. `git push origin HEAD:<branch-name>` — push the same branch to the base
   repo (origin points at `yongchand/gbrain-company`, not the fork). This is the move
...
4. `gh pr create --base base --head <branch-name>` — open the replacement
